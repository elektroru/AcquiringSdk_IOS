...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="emvco3ds_protocols_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol SDKChallengeProtocol;

SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios24GenericChallengeProtocol_")
...
SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios28MultiSelectChallengeProtocol_")
@protocol MultiSelectChallengeProtocol <GenericChallengeProtocol>
- (void)selectIndex:(NSInteger)index;
@end


SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios26OutOfBandChallengeProtocol_")
@protocol OutOfBandChallengeProtocol <GenericChallengeProtocol>
@end


SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios20SDKChallengeProtocol_")
@protocol SDKChallengeProtocol
- (void)handleChallenge;
@end


SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios31SingleSelectorChallengeProtocol_")
@protocol SingleSelectorChallengeProtocol <GenericChallengeProtocol>
- (void)selectObject:(NSInteger)index;
@end


SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios21TextChallengeProtocol_")
...
SWIFT_PROTOCOL("_TtP22emvco3ds_protocols_ios20WebChallengeProtocol_")
